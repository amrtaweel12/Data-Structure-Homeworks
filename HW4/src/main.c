...
int main() {
    ...
    int expection[] = {0,0,0,0,0};
    // Create processes with different nice values
    Process processes[] = {
        create_process(1, 0),    // Normal priority
        create_process(2, -9),  // High priority
        create_process(3, 9),   // Low priority
        create_process(4, -2),   // Above normal priority
        create_process(5, 2)     // Below normal priority
    };
